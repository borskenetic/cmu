@php
        ...
        [
            ...
            'children' => [
                ...
                [
                    ...
                    'patterns' => ['attendance_logs.index'],
                    'icon'     => 'clock',
                ],
                [
                    'label'    => 'Manage Video',
                ...
                [
                    ...
                    'route'    => 'attendance.section.settings',
                    'patterns' => ['attendance.section.settings*'],
                    'icon'     => 'grid',
                ],
                [
                    'label'    => 'Logout Feedback',
                    'route'    => 'attendance.feedback.settings',
                    'patterns' => ['attendance.feedback.settings*'],
                    'icon'     => 'message',
                ],
            ],
        ],
        [
            ...
            'children' => [
                [
                    ...
                    'patterns' => ['students.index', 'students.create', 'students.edit', 'students.report', 'pending.index', 'students.pending'],
                    'icon'     => 'users',
                ],
                [
                    'label'    => 'Employees',
        ...
        [
            ...
            'children' => [
                ...
                [
                    'label'    => 'SMS blast',
                    'route'    => 'sms.page',
                    'patterns' => ['sms.page', 'sms.send'],
                    'icon'     => 'send',
                ],
                [
                    'label'    => 'Scanner message',
                    'route'    => 'sms.scanMessage',
                    'patterns' => ['sms.scanMessage', 'sms.scanMessage.update'],
                    'icon'     => 'settings',
                ],
            ],
        ],
    ...
    $adminChildren = [
        ...
        [
            ...
            'route'    => 'users.create',
            'patterns' => ['users.create', 'users.store'],
            'icon'     => 'user-plus',
        ],
        [
            'label'    => 'View Accounts',
            'route'    => 'users.index',
            'patterns' => ['users.index', 'users.edit'],
            'icon'     => 'list',
        ],
    ];
...
<aside class="admin-sidebar" aria-label="Admin sidebar">
    ...
    <nav class="admin-sidebar-nav">
        ...
        @can('isAdmin')
            @php
                $adminActive = collect($adminChildren)->contains(fn ($child) => $isActive($child['patterns']));
            @endphp
